      ...
      <main>
        <section className="mx-auto max-w-5xl px-6 pt-24 pb-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            {/* App Store badge */}
            <a href="#" className="inline-flex items-center gap-3 rounded-2xl px-5 py-3 text-white transition-all hover:scale-[1.03] active:scale-[0.98] shadow-lg"
              style={{ background: "var(--color-night)" }}>
              <svg viewBox="0 0 24 24" className="w-7 h-7 fill-current flex-shrink-0"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
            ...
            <a href="#" className="inline-flex items-center gap-3 rounded-2xl px-5 py-3 text-white transition-all hover:scale-[1.03] active:scale-[0.98] shadow-lg"
              ...
              <svg viewBox="0 0 24 24" className="w-7 h-7 flex-shrink-0" fill="none">
                <path d="M3.18 23.76c.3.17.64.22.99.14L16.5 16.5 13.5 13.5 3.18 23.76z" fill="#EA4335"/>
                <path d="M20.82 10.15L17.5 8.25 14.25 11.5l3.25 3.25 3.32-1.9c.95-.54.95-1.66 0-2.2z" fill="#FBBC04"/>
                <path d="M4.17.24C3.87.07 3.53.02 3.18.1L13.5 10.5l3-3L4.17.24z" fill="#4285F4"/>
                <path d="M3.18.1L3.1.14C2.43.52 2 1.24 2 2.07v19.86c0 .83.43 1.55 1.1 1.93l.08.04L13.5 13.5 3.18.1z" fill="#34A853"/>
              </svg>
              <div className="text-left leading-tight">
